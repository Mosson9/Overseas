...
## 七、本目录文档导航
- **13 份中台 PRD**:账号登录注册 · 投放归因 · 支付 · 多语言本地化 · 运营活动 · 内容安全审核 · 用户 · 钱包计费 · 风控 · IM/RTC · 主播公会 · 消息推送召回 · 数据(各含交互原型)。
- **[MVP 迭代排期与依赖拓扑](MVP迭代排期与依赖拓扑.md)**:13 中台先做谁、谁依赖谁、4 期排期 + 甘特 + 关键路径。
- **[关键页面高保真原型(Canva)](原型图/README.md)**:登录页 / 收银台 / 语音房 / 人审工作台 的彩色视觉稿链接。
